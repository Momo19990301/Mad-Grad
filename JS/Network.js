        ...
        function initGraph() {
            ...
            // 節點半徑，使其看起來更像「點」
            nodes = [
{ id: 'Rocky', name: 'Rocky', x: nodeCanvas.width * 0.42383237678516716, y: nodeCanvas.height * 0.43675311804148664, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/Rocky.html' },
{ id: '小瓜', name: '小瓜', x: nodeCanvas.width * 0.777018104916865, y: nodeCanvas.height * 0.5870689019395846, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/小瓜.html' },
{ id: '慈慈', name: '慈慈', x: nodeCanvas.width * 0.6055544870136884, y: nodeCanvas.height * 0.31122072631089975, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/慈慈.html' },
{ id: '牛仔褲寶貝', name: '牛仔褲寶貝', x: nodeCanvas.width * 0.337861113975257, y: nodeCanvas.height * 0.29097847044082553, radius: 8.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/牛仔褲寶貝.html' },
{ id: '老人與狗', name: '老人與狗', x: nodeCanvas.width * 0.30255991997399007, y: nodeCanvas.height * 0.3777736973900441, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/老人與狗.html' },
{ id: '裘萌 & 首蒙元', name: '裘萌 & 首蒙元', x: nodeCanvas.width * 0.5950928272619695, y: nodeCanvas.height * 0.6335549220399955, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/裘萌 & 首蒙元.html' },
{ id: '阿詠', name: '阿詠', x: nodeCanvas.width * 0.6504757465250616, y: nodeCanvas.height * 0.6893702468276932, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/阿詠.html' },
{ id: 'Rock', name: 'Rock', x: nodeCanvas.width * 0.5992997007791815, y: nodeCanvas.height * 0.4109315213920079, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/Rock.html' },
{ id: '深淵', name: '深淵', x: nodeCanvas.width * 0.45886014941665604, y: nodeCanvas.height * 0.20693546771606247, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/深淵.html' },
{ id: '球球', name: '球球', x: nodeCanvas.width * 0.5237836796587788, y: nodeCanvas.height * 0.7741385845157428, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/球球.html' },
{ id: '穢土轉生研究生', name: '穢土轉生研究生', x: nodeCanvas.width * 0.5878531386762154, y: nodeCanvas.height * 0.735444919556231, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/穢土轉生研究生.html' },
{ id: '憑拳大將軍', name: '憑拳大將軍', x: nodeCanvas.width * 0.5449418314261149, y: nodeCanvas.height * 0.35290896554529966, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/憑拳大將軍.html' },
{ id: '懶惰小依 & 賴床小依', name: '懶惰小依 & 賴床小依', x: nodeCanvas.width * 0.6323214718647006, y: nodeCanvas.height * 0.49785784205083267, radius: 9.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/懶惰小依 & 賴床小依.html' },
{ id: '渟渟急轉彎', name: '渟渟急轉彎', x: nodeCanvas.width * 0.665963181133237, y: nodeCanvas.height * 0.411365668840618, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/渟渟急轉彎.html' },
{ id: '王依渟', name: '王依渟', x: nodeCanvas.width * 0.2811596198343242, y: nodeCanvas.height * 0.6344319683593658, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/王依渟.html' },
{ id: '紀崴', name: '紀崴', x: nodeCanvas.width * 0.5345003485212828, y: nodeCanvas.height * 0.6754383031306245, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/紀崴.html' },
{ id: '蒂娜', name: '蒂娜', x: nodeCanvas.width * 0.8011357760076324, y: nodeCanvas.height * 0.49326593306817995, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/蒂娜.html' },
{ id: '海神巨獸', name: '海神巨獸', x: nodeCanvas.width * 0.4445395538055038, y: nodeCanvas.height * 0.5810788220920821, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'EMCA Lab/海神巨獸.html' },
{ id: '金門王', name: '金門王', x: nodeCanvas.width * 0.5509783605009555, y: nodeCanvas.height * 0.2532710232499674, radius: 8.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'EMCA Lab/金門王.html' },
{ id: 'AIoT Lab', name: 'AIoT Lab', x: nodeCanvas.width * 0.6582267797114237, y: nodeCanvas.height * 0.590006572907207, radius: 8.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/AIoT Lab.html' },
{ id: 'Badass', name: 'Badass', x: nodeCanvas.width * 0.6989878453142511, y: nodeCanvas.height * 0.4987189430855694, radius: 8.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/Badass.html' },
{ id: 'EMCA Lab', name: 'EMCA Lab', x: nodeCanvas.width * 0.6722451677258415, y: nodeCanvas.height * 0.31177045207112003, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/EMCA Lab.html' },
{ id: 'SoC Lab', name: 'SoC Lab', x: nodeCanvas.width * 0.3901486711127842, y: nodeCanvas.height * 0.5230752547218259, radius: 13.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/SoC Lab.html' },
{ id: 'Prof. 蛋頭博士', name: 'Prof. 蛋頭博士', x: nodeCanvas.width * 0.47817645540210324, y: nodeCanvas.height * 0.49473665376904313, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/Prof. 蛋頭博士.html' },
{ id: '余十三', name: '余十三', x: nodeCanvas.width * 0.48439359324402126, y: nodeCanvas.height * 0.39481175523729045, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/余十三.html' },
{ id: '小南瓜', name: '小南瓜', x: nodeCanvas.width * 0.3838928805394787, y: nodeCanvas.height * 0.6226566258370587, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/小南瓜.html' },
{ id: '徐丞丞', name: '徐丞丞', x: nodeCanvas.width * 0.34143096796571765, y: nodeCanvas.height * 0.6999212063819451, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/徐丞丞.html' },
{ id: '心碎小狗', name: '心碎小狗', x: nodeCanvas.width * 0.32930796793099526, y: nodeCanvas.height * 0.5651721289543218, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/心碎小狗.html' },
{ id: '應葛格', name: '應葛格', x: nodeCanvas.width * 0.39794465936176104, y: nodeCanvas.height * 0.24760240501268974, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/應葛格.html' },
{ id: '敦敦', name: '敦敦', x: nodeCanvas.width * 0.407191634121831, y: nodeCanvas.height * 0.7166964038022988, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/敦敦.html' },
{ id: '梵楓霖', name: '梵楓霖', x: nodeCanvas.width * 0.269013155366074, y: nodeCanvas.height * 0.4734020004509699, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/梵楓霖.html' },
{ id: '橋牌社長', name: '橋牌社長', x: nodeCanvas.width * 0.4677959800207553, y: nodeCanvas.height * 0.674895448748956, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/橋牌社長.html' },
{ id: '湖口砲兵連連長', name: '湖口砲兵連連長', x: nodeCanvas.width * 0.4573203961420456, y: nodeCanvas.height * 0.7826130067105023, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/湖口砲兵連連長.html' },
{ id: '焦糖o彤兒', name: '焦糖o彤兒', x: nodeCanvas.width * 0.3692506341099108, y: nodeCanvas.height * 0.3792561408841646, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/焦糖o彤兒.html' },
{ id: '珊珊姊', name: '珊珊姊', x: nodeCanvas.width * 0.4903126911921056, y: nodeCanvas.height * 0.2951647422813779, radius: 8.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/珊珊姊.html' },
{ id: '色彩學大師', name: '色彩學大師', x: nodeCanvas.width * 0.5387403245674792, y: nodeCanvas.height * 0.4528003774633447, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/色彩學大師.html' },
{ id: '諸葛小劉', name: '諸葛小劉', x: nodeCanvas.width * 0.4293299581517381, y: nodeCanvas.height * 0.33590530325556095, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/諸葛小劉.html' },
{ id: '陳大帥帥', name: '陳大帥帥', x: nodeCanvas.width * 0.571793215940716, y: nodeCanvas.height * 0.539728006283633, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/陳大帥帥.html' },
{ id: '馬華', name: '馬華', x: nodeCanvas.width * 0.5112387706509607, y: nodeCanvas.height * 0.5816887730831861, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/馬華.html' },
{ id: '黃老二', name: '黃老二', x: nodeCanvas.width * 0.33552686335143006, y: nodeCanvas.height * 0.4655886965503884, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/黃老二.html' }
]; 
            links = [
