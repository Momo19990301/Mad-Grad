        ...
        function initGraph() {
            ...
            // 節點半徑，使其看起來更像「點」
            nodes = [
{ id: 'Rocky', name: 'Rocky', x: nodeCanvas.width * 0.39936513959173814, y: nodeCanvas.height * 0.3783779944345966, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/Rocky.html' },
{ id: '小瓜', name: '小瓜', x: nodeCanvas.width * 0.785637706771329, y: nodeCanvas.height * 0.582035545574979, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/小瓜.html' },
{ id: '慈慈', name: '慈慈', x: nodeCanvas.width * 0.47675203775819935, y: nodeCanvas.height * 0.5786727121840106, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/慈慈.html' },
{ id: '牛仔褲寶貝', name: '牛仔褲寶貝', x: nodeCanvas.width * 0.3472722560160644, y: nodeCanvas.height * 0.27373763040620913, radius: 8.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/牛仔褲寶貝.html' },
{ id: '老人與狗', name: '老人與狗', x: nodeCanvas.width * 0.5255374366784726, y: nodeCanvas.height * 0.19550139208110143, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/老人與狗.html' },
{ id: '裘萌 & 首蒙元', name: '裘萌 & 首蒙元', x: nodeCanvas.width * 0.5687811595813985, y: nodeCanvas.height * 0.7206205047574283, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/裘萌 & 首蒙元.html' },
{ id: '阿詠', name: '阿詠', x: nodeCanvas.width * 0.6350406254422022, y: nodeCanvas.height * 0.7080908483466075, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'AIoT Lab/阿詠.html' },
{ id: 'Rock', name: 'Rock', x: nodeCanvas.width * 0.5936118410352439, y: nodeCanvas.height * 0.3588008268899573, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/Rock.html' },
{ id: '深淵', name: '深淵', x: nodeCanvas.width * 0.6615697909767683, y: nodeCanvas.height * 0.6138939007673063, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/深淵.html' },
{ id: '球球', name: '球球', x: nodeCanvas.width * 0.5442886910644942, y: nodeCanvas.height * 0.29148142722593984, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/球球.html' },
{ id: '穢土轉生研究生', name: '穢土轉生研究生', x: nodeCanvas.width * 0.6199657992969798, y: nodeCanvas.height * 0.5356818578027688, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Appendix/穢土轉生研究生.html' },
{ id: '憑拳大將軍', name: '憑拳大將軍', x: nodeCanvas.width * 0.4385993073865231, y: nodeCanvas.height * 0.49646841605352265, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/憑拳大將軍.html' },
{ id: '懶惰小依 & 賴床小依', name: '懶惰小依 & 賴床小依', x: nodeCanvas.width * 0.31757194785564263, y: nodeCanvas.height * 0.6520659675129079, radius: 9.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/懶惰小依 & 賴床小依.html' },
{ id: '渟渟急轉彎', name: '渟渟急轉彎', x: nodeCanvas.width * 0.6078385823414013, y: nodeCanvas.height * 0.261011616874811, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/渟渟急轉彎.html' },
{ id: '王依渟', name: '王依渟', x: nodeCanvas.width * 0.6886265767196998, y: nodeCanvas.height * 0.37972559349830043, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/王依渟.html' },
{ id: '紀崴', name: '紀崴', x: nodeCanvas.width * 0.5047367607783918, y: nodeCanvas.height * 0.4829989681763, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/紀崴.html' },
{ id: '蒂娜', name: '蒂娜', x: nodeCanvas.width * 0.7016186593336825, y: nodeCanvas.height * 0.7006258576141587, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Badass/蒂娜.html' },
{ id: '海神巨獸', name: '海神巨獸', x: nodeCanvas.width * 0.46384670409386075, y: nodeCanvas.height * 0.40390908511469775, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'EMCA Lab/海神巨獸.html' },
{ id: '金門王', name: '金門王', x: nodeCanvas.width * 0.5156366460085342, y: nodeCanvas.height * 0.6600040453778172, radius: 8.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'EMCA Lab/金門王.html' },
{ id: 'AIoT Lab', name: 'AIoT Lab', x: nodeCanvas.width * 0.6852147229421904, y: nodeCanvas.height * 0.5151766444326004, radius: 8.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/AIoT Lab.html' },
{ id: 'Badass', name: 'Badass', x: nodeCanvas.width * 0.5405410149935022, y: nodeCanvas.height * 0.8113473638049371, radius: 8.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/Badass.html' },
{ id: 'EMCA Lab', name: 'EMCA Lab', x: nodeCanvas.width * 0.421321625680297, y: nodeCanvas.height * 0.7638052342242705, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/EMCA Lab.html' },
{ id: 'SoC Lab', name: 'SoC Lab', x: nodeCanvas.width * 0.37414633764150085, y: nodeCanvas.height * 0.4709592677147093, radius: 13.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'Lab/SoC Lab.html' },
{ id: 'Prof. 蛋頭博士', name: 'Prof. 蛋頭博士', x: nodeCanvas.width * 0.48743191875536157, y: nodeCanvas.height * 0.7506970665078475, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/Prof. 蛋頭博士.html' },
{ id: '余十三', name: '余十三', x: nodeCanvas.width * 0.3441718193413201, y: nodeCanvas.height * 0.5603400661059684, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/余十三.html' },
{ id: '小南瓜', name: '小南瓜', x: nodeCanvas.width * 0.5707186936081753, y: nodeCanvas.height * 0.46812057021133446, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/小南瓜.html' },
{ id: '徐丞丞', name: '徐丞丞', x: nodeCanvas.width * 0.32924345233258007, y: nodeCanvas.height * 0.3970190941659546, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/徐丞丞.html' },
{ id: '心碎小狗', name: '心碎小狗', x: nodeCanvas.width * 0.5428261509942857, y: nodeCanvas.height * 0.5653091674930435, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/心碎小狗.html' },
{ id: '應葛格', name: '應葛格', x: nodeCanvas.width * 0.4086808221266338, y: nodeCanvas.height * 0.5858740703719857, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/應葛格.html' },
{ id: '敦敦', name: '敦敦', x: nodeCanvas.width * 0.41377660672901667, y: nodeCanvas.height * 0.28073144947083056, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/敦敦.html' },
{ id: '梵楓霖', name: '梵楓霖', x: nodeCanvas.width * 0.3931729646003878, y: nodeCanvas.height * 0.18551459270150894, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/梵楓霖.html' },
{ id: '橋牌社長', name: '橋牌社長', x: nodeCanvas.width * 0.38206291739807713, y: nodeCanvas.height * 0.6775740709385011, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/橋牌社長.html' },
{ id: '湖口砲兵連連長', name: '湖口砲兵連連長', x: nodeCanvas.width * 0.5946579917707965, y: nodeCanvas.height * 0.6283535721868292, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/湖口砲兵連連長.html' },
{ id: '焦糖o彤兒', name: '焦糖o彤兒', x: nodeCanvas.width * 0.29121431485526195, y: nodeCanvas.height * 0.4792584320164211, radius: 6.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/焦糖o彤兒.html' },
{ id: '珊珊姊', name: '珊珊姊', x: nodeCanvas.width * 0.2741665063777121, y: nodeCanvas.height * 0.5759668920346386, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/珊珊姊.html' },
{ id: '色彩學大師', name: '色彩學大師', x: nodeCanvas.width * 0.4783153577182481, y: nodeCanvas.height * 0.30604048305777665, radius: 7.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/色彩學大師.html' },
{ id: '諸葛小劉', name: '諸葛小劉', x: nodeCanvas.width * 0.4485093217519373, y: nodeCanvas.height * 0.6693525410162815, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/諸葛小劉.html' },
{ id: '陳大帥帥', name: '陳大帥帥', x: nodeCanvas.width * 0.45931527228606994, y: nodeCanvas.height * 0.20765253577576662, radius: 6.0, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/陳大帥帥.html' },
{ id: '馬華', name: '馬華', x: nodeCanvas.width * 0.6344132586264357, y: nodeCanvas.height * 0.4380347593880678, radius: 5.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/馬華.html' },
{ id: '黃老二', name: '黃老二', x: nodeCanvas.width * 0.5298012607395786, y: nodeCanvas.height * 0.38916793568730623, radius: 7.5, originalColor: '#FFFFFF', color: '#FFFFFF', originalTextColor: '#FFFFFF', textColor: '#FFFFFF', vx: 0, vy: 0, isDragged: false, isHighlighted: false, currentTextYOffset: 0, link: 'SoC Lab/黃老二.html' }
]; 
            links = [
